					...
					<div class="col-lg-6">
						<div class="login-content" >
							<div class="login-logo">
								<a href="#"><span>添加菜单</span></a>
							</div>
							<div class="login-form">
								<form class="layui-form " id="addFoodMenusForm"> <!-- 提示：如果你不想用form，你可以换成div等任何一个普通元素 -->
								  ...
								  <div class="layui-form-item layui-form-text">
								    ...
								    <div class="layui-input-block">
								      <input type="text" name="foodMaterial" placeholder="请输入原料（用 - 隔开）" autocomplete="off" class="layui-input">
								    </div>
								  </div>
								  <div class="layui-form-item">
								    <label class="layui-form-label">原价</label>
								    <div class="layui-input-block">
								      <input type="number" name="oldPrice" placeholder="请输入价格" autocomplete="off" class="layui-input">
								    </div>
								  </div>
								  <div class="layui-form-item">
								    <label class="layui-form-label">现价</label>
								    <div class="layui-input-block">
								      <input type="number" name="newPrice" placeholder="请输入价格" autocomplete="off" class="layui-input">
								    </div>
								  </div>
								  <input type="hidden" id="imgFoodMenusPath" name="foodImg"/>
								...
								<div class="layui-form-item">
								    <div class="layui-input-block">
								      <button class="layui-btn" type="button" id="add_food_menus_btn">提交</button>
...
$("#add_food_menus_btn").click(function(){
	var data = $("#addFoodMenusForm").serialize(); 
	layui.use(['layer','form'], function(){
		 layer = layui.layer
		 ,form = layui.form;
		$.ajax({
			url:"${APP_PATH}/foodMenus/addFoodMenus",
			method:"POST",
			data:data,
