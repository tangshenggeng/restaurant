					...
					<div class="col-lg-6">
						<div class="login-content" >
							<div class="login-logo">
								<a href="#"><span>美食上新</span></a>
							</div>
							<div class="login-form">
								<form class="layui-form " id="addNewFoodForm"> <!-- 提示：如果你不想用form，你可以换成div等任何一个普通元素 -->
								  ...
								  <div class="layui-form-item">
								    ...
								    <div class="layui-input-block">
								      <input type="number" name="foodPrice" placeholder="请输入价格" autocomplete="off" class="layui-input">
								    </div>
								  </div>
								...
								<div class="layui-form-item">
								    <div class="layui-input-block">
								      <button class="layui-btn" type="button" id="add_new_food_btn">提交</button>
...
$("#add_new_food_btn").click(function(){
	var data = $("#addNewFoodForm").serialize(); 
	layui.use(['layer','form'], function(){
		 layer = layui.layer
		 ,form = layui.form;
		$.ajax({
			url:"${APP_PATH}/newFood/addNewFood",
			method:"POST",
			data:data,
